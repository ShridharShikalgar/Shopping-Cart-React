export const Data =[
  ...
  }, 
  {
        ...
        Iphone: [
                    {
                    title: "Iphone",
                    list: ["All","Iphone-7","Iphone-8", "Iphone-9", "Iphone-x","Iphone-11","Iphone-12"]
                    },
                    {
                    title: "One-Plus",
                    list: ["All", "One-Plus1", "One-Plus2","One-Plus3","One-Plus Nord"]
                    },
                    {
                    title: "Oppo",
                    list: ["Oppo-f1", "Oppo-f2", "Oppo-f3","Oppo-f4","Oppo-f7","Oppo-f8","Oppo-f9"]
                    }
        ]
  },
  {
    ...
    MenCollection:[
                    {
                    title: "Men's",
                    list: ["All","Men's T-Shirts", "Men's Casual Shirts", "Men's Formal Shirts","Men's Kurtas","Men's Ethnic Sets"]
                    },
                    {
                    title: "Men's Bottom Wear",
                    list: ["All", "Men's Jeans", "Men's Trousers","Men's Trackpants","Men's Shorts"]
                    },
                    {
                    title: "Women Ethnic",
                    list: ["All", "Women Tops", "Women Dresses","Women T-shirts","Women Nightsuit","Women Jeans"]
                    },
                    {
                    title: "Men's Western",
                    list: ["All", "Men's Jeans", "Men's Trousers","Men's Trackpants","Men's Shorts"]
                    ...
                    {
                    title: "Women Ethnic",
                    list: ["All", "Women Sarees", "Women Kurtas & Kurtis","Women Kurta Sets & Salwar Suits","Ethnic Dresses","Women Gowns"]
                    }
    ]
  },
  {
    ...
    TV:[
        {
        title: "Television",
        list: ["All","Sony", "Lg", "Samsung","Panasonic"]
        },
        {
        title: "Hair-Dryer",
        list: ["All", "Phillips", "Aqua", "Clever","Mistubuj"]
        }
    ]
  },
  {
